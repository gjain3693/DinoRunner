...
public class GameManager09 : MonoBehaviour
{
    ...
    public AlternatingSpawner spawnner;

    public static GameManager09 instance;

    // Safe respawn position
    public Transform respawnPoint;

    public int NEXT_LEVEL_SCORE_REQ = 90;
    ...
    public void IncreaseScore()
    {
        ...
        {
            if (Application.CanStreamedLevelBeLoaded("Level10"))
            {
            ...
            {
                Debug.LogError(
                    "Level10 missing from Build Settings."
                );
            }
