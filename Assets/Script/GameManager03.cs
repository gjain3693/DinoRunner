...
public class GameManager03 : MonoBehaviour
{
    ...
    public static GameManager03 instance;

    // Safe respawn position
    public Transform respawnPoint;

    public int NEXT_LEVEL_SCORE_REQ = 30;
    ...
    public void IncreaseScore()
    {
        ...
        {
            if (Application.CanStreamedLevelBeLoaded("Level04"))
            {
            ...
            {
                Debug.LogError(
                    "Level04 missing from Build Settings."
                );
            }
