...
public class GameManager08 : MonoBehaviour
{
    ...
    public static GameManager08 instance;

    // Safe respawn position
    public Transform respawnPoint;

    public int NEXT_LEVEL_SCORE_REQ = 80;
    ...
    public void IncreaseScore()
    {
        ...
        {
            if (Application.CanStreamedLevelBeLoaded("Level09"))
            {
            ...
            {
                Debug.LogError(
                    "Level09 missing from Build Settings."
                );
            }
