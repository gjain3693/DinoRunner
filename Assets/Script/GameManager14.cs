...
public class GameManager14 : MonoBehaviour
{
    ...
    public static GameManager14 instance;

    // Safe respawn position
    public Transform respawnPoint;

    public int NEXT_LEVEL_SCORE_REQ = 180;
    ...
    public void IncreaseScore()
    {
        ...
        {
            if (Application.CanStreamedLevelBeLoaded("Level15"))
            {
            ...
            {
                Debug.LogError(
                    "Level15 missing from Build Settings."
                );
            }
