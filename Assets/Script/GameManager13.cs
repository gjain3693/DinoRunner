...
public class GameManager13 : MonoBehaviour
{
    ...
    public static GameManager13 instance;

    // Safe respawn position
    public Transform respawnPoint;

    public int NEXT_LEVEL_SCORE_REQ = 160;
    ...
    public void IncreaseScore()
    {
        ...
        {
            if (Application.CanStreamedLevelBeLoaded("Level14"))
            {
            ...
            {
                Debug.LogError(
                    "Level14 missing from Build Settings."
                );
            }
