...
public class GameManager04 : MonoBehaviour
{
    ...
    public static GameManager04 instance;

    // Safe respawn position
    public Transform respawnPoint;

    public int NEXT_LEVEL_SCORE_REQ = 40;
    ...
    public void IncreaseScore()
    {
        ...
        {
            if (Application.CanStreamedLevelBeLoaded("Level05"))
            {
            ...
            {
                Debug.LogError(
                    "Level05 missing from Build Settings."
                );
            }
